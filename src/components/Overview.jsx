    ...
    <>
      <Row>
        <Col md={2} className='onMobile'>
          <i className='fa-regular fa-calendar-minus m-1 mb-2'></i>
        </Col>
        <Col md={4} className='onMobile'>
          <h4 className='for-mobile-size'>Habits</h4>
        </Col>
      </Row>
      <ListGroup>
        {habits.map((habit, index) => (
          <ListGroup.Item key={index} className='gradient1 mb-1 rounded habit-container'>
            <Row>
      ...
      <Row>
        ...
        <Col className='d-flex justify-content-end'>
          <Button
            type='button'
            className='bg-primary mt-2 mobile'
